...
The API was written and tested using Python 2.6 under CentOS 6.x, and using Python 2.7x, including Iron Python on .NET.  The library is a single file and pure Python.  You can install with "pip ekmmeters" or download the library file directly.  There are no external dependencies beyond json, collections, and pyserial.
